...
declare_id!("9s2A518xFyqkFH7naS1Z3H4gQaMDdJcVuF9A2bp918xj");
...
pub mod anchor_nft_staking {
    ...
    pub fn redeem(ctx: Context<Redeem>) -> Result<()> {
        ...
        let unix_time = clock.unix_timestamp - ctx.accounts.stake_state.last_stake_redeem; // seconds since last redeem
        ...
        token::mint_to(CpiContext::new_with_signer(
            ...
            &[&[b"mint".as_ref(), &[*ctx.bumps.get("stake_authority").unwrap()]]]), 
